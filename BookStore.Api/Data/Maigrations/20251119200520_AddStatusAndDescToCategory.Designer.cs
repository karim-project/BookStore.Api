...
namespace BookStore.Api.Data.Maigrations
{
    ...
    [Migration("20251119200520_AddStatusAndDescToCategory")]
    partial class AddStatusAndDescToCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Api.Models.ApplicationUserOTP", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BookStore.Api.Models.Orders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Api.Models.OrdersItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookStore.Api.Models.OrdersItem", b =>
                {
                    ...
                    b.HasOne("BookStore.Api.Models.Orders", "Orders")
                        .WithMany("Items")
